            ...
            <div class="mt-8">
                <div class="mt-6">
                    <form action="#" method="POST" class="space-y-6">
                        ...
                        <div>
                            <button type="submit" name="submit" value="login now" class="flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" fdprocessedid="ezn6qi">login now</button>
                        </div>
                    </form>
                    ...
                    <div>
                        <button type="submit" class="w-full items-center block px-10 py-3.5 text-base font-medium text-center text-blue-600 transition duration-500 ease-in-out transform border-2 border-white shadow-md rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" fdprocessedid="wzw5p">
                            <div class="flex items-center justify-center">
                                ...
                                <span class="ml-4"><a href="register.php">register now</a></span>
                            </div>
                        </button>
                    </div>
                </div>
